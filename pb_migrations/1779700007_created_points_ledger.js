...
// Airtable POINTS_LEDGER -> PocketBase points_ledger. CONFIRMED from code:
// routes/webhook.ts appends { user_id -> relation user, delta, reason, ref_id, created_at }
// when a referral vests. Append-only ledger.
migrate((app) => {
